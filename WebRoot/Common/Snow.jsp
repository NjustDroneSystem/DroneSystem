...
<script type="text/javascript">
	...
	var opts = {
		width : 0,     // 信息窗口宽度
		height: 0,     // 信息窗口高度
		title : "<span style='font-size:35px;color:#0099cc;background-color:#FFFFFF'>"+"雪阻信息窗口"+"</span>" , // 信息窗口标题
			   ...
			   // deletePoint();
				for(var i=0;i<data.drones.length;i++) { 
		            ...
		            (function(){
						...
						id = vlc.playlist.add("../Inc/snow_detection.mp4"); //添加mrl到播放列表						
	...
	function sendURL(droneId){
	  $.ajax({
          	...
          	data:{droneId:droneId, type:1,inputStream:"D:\\test\\snow_detection.mp4"},
